...
const StepInfo = ({ number, label, accountType }: any) => {
    return (
        <div className=" flex flex-col gap-1">
            <p className="text-blue_color text-xs font-bold ">
                Step {number}/{accountType === "patient" ? "9" : accountType === "hospital" ? "6" :3}
            </p>
      ...
      <div className="w-full h-full">
        <div className="flex flex-wrap gap-10 justify-center items-center ">
          ...
          <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
            ...
            {active === 1 && (
              <StepInfo number={1} label={"Account Type"} accountType={accountType} />
            )}
          </div>
          ...
          <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
            ...
            {active === 2 && <StepInfo number={2} label={"Verification"} />}
          </div>
          ...
          {accountType === "patient" && (
            <>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                <div
                  className={`${
                    active === 3 ? "bg-blue_color" : "bg-sky_color"
                  } h-16 w-16 rounded-full p-2 flex justify-center items-center `}>
                  <img
                ...
                {active === 3 && <StepInfo number={3} label={"Personal Details"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                <div
                  className={`${
                    active === 4 ? "bg-blue_color" : "bg-sky_color"
                  } h-16 w-16 rounded-full p-2 flex justify-center items-center `}>
                  <img
                ...
                {active === 4 && <StepInfo number={4} label={"Travel Details"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                <div
                  className={`${
                    active === 5 ? "bg-blue_color" : "bg-sky_color"
                  } h-16 w-16 rounded-full p-2 flex justify-center items-center `}>
                  <img
                ...
                {active === 5 && <StepInfo number={5} label={"Medical History"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                <div
                  className={`${
                    active === 6 ? "bg-blue_color" : "bg-sky_color"
                  } h-16 w-16 rounded-full p-2 flex justify-center items-center `}>
                  <img
                ...
                {active === 6 && <StepInfo number={6} label={"Immunization History"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                <div
                  className={`${
                    active === 7 ? "bg-blue_color" : "bg-sky_color"
                  } h-16 w-16 rounded-full p-2 flex justify-center items-center `}>
                  <img
                ...
                {active === 7 && <StepInfo number={7} label={"Emergency Contacts"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                <div
                  className={`${
                    active === 8 ? "bg-blue_color" : "bg-sky_color"
                  } h-16 w-16 rounded-full p-2 flex justify-center items-center `}>
                  <img
                ...
                {active === 8 && <StepInfo number={7} label={"Lifestyle Factors"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                <div
                  className={`${
                    active === 9 ? "bg-blue_color" : "bg-sky_color"
                  } h-16 w-16 rounded-full p-2 flex justify-center items-center `}>
                  <img
                ...
                {active === 9 && <StepInfo number={7} label={"Upload Documents"} />}
              </div>
            </>
          )}
          ...
          {accountType === "hospital" && (
            <>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                ...
                {active === 3 && <StepInfo number={3} label={"General Information"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                ...
                {active === 4 && <StepInfo number={4} label={"Upload Logo"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                ...
                {active === 5 && <StepInfo number={5} label={"Working Hours"} />}
              </div>
              ...
              <div className="flex w-auto h-full justify-center items-center gap-2 slide_top">
                ...
                {active === 6 && <StepInfo number={6} label={"Available Doctors"} />}
              </div>
            </>
          )}
          {/* Ambulance */}
